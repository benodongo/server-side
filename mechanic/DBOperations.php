...
public function __construct() {
 ...
 public function insertData($name,$email,$password){
	...
	$salt = $hash["salt"];
 	...
 	$sql = 'INSERT INTO mechanics SET unique_id =:unique_id,name =:name,
 ...
 public function changePassword($email, $password){
    ...
    $sql = 'UPDATE mechanics SET encrypted_password = :encrypted_password, salt = :salt WHERE email = :email';
    $query = $this -> conn -> prepare($sql);
...
public function locations($placename,$latitude,$longitude,$address,$email){
 ...
 public function checkUserExist($email){
    ...
    $sql = 'SELECT COUNT(*) from mechanics WHERE email =:email';
    $query = $this -> conn -> prepare($sql);
    $query -> execute(array('email' => $email));
